...
function uploadAudio(blob) {
  ...
  xhr.onload = function (e) {
    if (this.readyState === 4) {
      ...
      returnURL = new URL(this.responseURL);
      queryString = returnURL.search;
      urlParams = new URLSearchParams(queryString);
      eventSummary = urlParams.get('eventSummary');
      emailList = urlParams.get('emailList');
      startDate = urlParams.get('startDate');
      endDate = urlParams.get('endDate');
      startTime = urlParams.get('startTime');
      endTime = urlParams.get('endTime');
      location2 = urlParams.get('location');
  ...
  var fd = new FormData();
  fd.append("audio_data", blob, "webVoice");
